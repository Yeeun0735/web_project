...
var guids = require('./routes/guids');
...
module.exports = (app, io) => {
  ...
  const connStr = (process.env.NODE_ENV == 'production')?
    'mongo "mongodb+srv://cluster0-huqws.mongodb.net/test"  --username user1':
    'mongodb://localhost/web_project';
  ...
  const sessionId = 'myrealtrip.sid';
